module yaeos__models_ar_genericcubic
   ...
   ! type, extends(CubicMixRule) :: CubicMixRuleNano
   ! contains
   !    ! procedure(abs_Dmix), deferred :: Dmix
   !    ! procedure(abs_Bmix), deferred :: Bmix
   !    ! procedure(abs_D1mix), deferred :: D1mix
   !    procedure(abs_alpha_adsorption_mix), deferred :: alpha_ads_mix
   ! end type
   ...
   abstract interface
      ...
      subroutine abs_D1mix(self, n, d1i, D1, dD1i, dD1ij)
         ...
         ! subroutine abs_alpha_adsorption_mix(self, n, alpha_ads_i, alpha_ads_mix, dalpha_ads_mixi, dalpha_ads_mixij)
      !    import CubicMixRule, pr
      !    class(CubicMixRule), intent(in) :: self
      !    real(pr), intent(in) :: n(:)
